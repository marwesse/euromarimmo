                ...
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4 p-5 bg-bg-offwhite rounded-2xl border border-gray-100">
                    ...
                    >
                        <div className="relative">
                            <div className="absolute inset-0 bg-white rounded-[40px] shadow-[0_20px_60px_rgb(0,0,0,0.05)] border border-gray-100 h-full w-full"></div>

                            <div className="relative bg-white rounded-[40px] p-8 md:p-12">
                                <div className="space-y-10">

                                    {/* Montant slider */}
                                    <div>
                                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-6 gap-2">
                                            <label className="text-sm font-semibold text-gray-500 uppercase tracking-widest">Montant du prêt</label>
                                            <span className="text-3xl font-serif text-primary">{formatCurrency(amount)}</span>
                                        </div>
                                        <div className="relative py-4">
                                            <input
                                                ...
                                                className="w-full h-2 bg-gray-100 rounded-lg appearance-none cursor-pointer hover:bg-gray-200 transition-colors [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:bg-accent [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:shadow-lg"
                                            />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 pt-6 border-t border-gray-100">
                                        <div className="group">
                                            <label className="text-sm font-semibold text-gray-500 uppercase tracking-widest block mb-4 transition-colors group-focus-within:text-accent">Taux d&apos;intérêt (%)</label>
                                            <div className="relative flex items-center">
                                                <input
                                                    ...
                                                    step="0.1"
                                                    className="w-full bg-transparent border-b-2 border-gray-100 py-3 text-primary font-serif text-2xl focus:outline-none focus:border-accent transition-colors"
                                                />
                                        ...
                                        <div className="group">
                                            <label className="text-sm font-semibold text-gray-500 uppercase tracking-widest block mb-4 transition-colors group-focus-within:text-accent">Durée (Années)</label>
                                            <div className="relative flex items-center">
                                                <input
                                                    type="number"
                                                    value={years}
